...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/flexdevelopment
   cd flexdevelopment
   ```
...
```sh
https://github.com/flex-development/flexdevelopment/compare/main...$branch
```
...
> Note: Deployments and release publication is executed via GitHub workflow.\
...
[qa]: https://github.com/flex-development/flexdevelopment/discussions/new?category=q-a
